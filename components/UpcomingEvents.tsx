    ...
    <section id="events" aria-labelledby="events-heading">
      ...
      <div className="space-y-3">
        {events.map((event) => (
          <article
            key={event.title}
            className="grid gap-4 rounded-[8px] border border-[#0f2d4a]/10 bg-white p-4 shadow-sm sm:grid-cols-[72px_1fr_auto] sm:items-center"
          >
            <div className="flex h-20 w-[72px] flex-col items-center justify-center rounded-[8px] bg-[#0f2d4a] text-white">
            ...
            <a
              href="#assistant"
              className="rounded-full border border-[#0f2d4a]/15 px-4 py-2 text-center text-sm font-bold text-[#0f2d4a] transition hover:border-[#d7a84d]"
            >
              Register
            </a>
          </article>
